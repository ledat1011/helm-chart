...
helm.sh/chart: {{ include "server-chart.chart" . }}
...
*/}}
{{- define "server-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "server-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
